      ...
      <div class="col-8 q-my-md" style="padding: 0 32px">
        <div class="row">
          <div class="col-8 q-pr-md">
            <div class="full-width row bg-white br-10 q-px-md">
              <div class="row">
                <div class="col-12">
                  <q-badge
                ...
                <div class="q-mt-md q-mb-lg row justify-between">
                  <div class="col-12 q-pr-xl">
                    <q-item class="full-width">
                      ...
                      <q-item-section>
                        <q-item-label style="font-size: 16px" class="text-bold"
                  ...
                  <div class="row q-px-md">
                    <div class="col-12 q-mt-md text-grey-8">
                      معین صداقتی متولد سال 1386/9/9. از 13 سالگی شروع به یاد
                      گیری برنامه نویسی کردم و از 15 سالگی به صورت جدی برنامه
                      نویسی میکنم.
                    </div>
